# Awesome Vala [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
* [Akira](https://github.com/akiraux/Akira) ⭐ 5,325 | 🐛 40 | 🌐 Vala | 📅 2025-12-30 -  Native Linux App for UI and UX Design built in Vala and GTK.
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 539 | 🐛 77 | 🌐 Vala | 📅 2025-11-23 - A font editor for creating fonts in TTF, EOT, SVG and BIRDFONT format.

### Development Tools

* [GitG](https://gitlab.gnome.org/GNOME/gitg) - A graphical user interface for [git](https://git-scm.com/).
* [Kangaroo](https://github.com/dbkangaroo/kangaroo) ⭐ 469 | 🐛 28 | 🌐 TSQL | 📅 2026-03-31 - AI-powered SQL client and admin tool for popular databases.
...
* [GameHub](https://github.com/tkashkin/GameHub) ⚠️ Archived - A unified library for all your games.
* [Warble](https://github.com/avojak/warble) ⭐ 88 | 🐛 5 | 🌐 Vala | 📅 2024-11-05 - Native Linux word-guessing game built in Vala and Gtk for elementary OS.
* [Sage](https://github.com/antolius/sage) ⭐ 10 | 🐛 2 | 🌐 Vala | 📅 2022-08-08 - A code breaking game made for elementary OS.
...
* [Korembi](https://github.com/cheesecakeufo/komorebi) ⭐ 3,714 | 🐛 290 | 🌐 Vala | 📅 2025-07-21 - A beautiful and customizable wallpapers manager for Linux.

### Productivity

* [Planify](https://github.com/alainm23/planify) ⭐ 5,258 | 🐛 138 | 🌐 Vala | 📅 2026-05-03 - Task manager with Todoist support designed for GNU/Linux.
* [Dino](https://github.com/dino/dino) ⭐ 2,436 | 🐛 658 | 🌐 Vala | 📅 2026-04-24 - A modern Jabber/XMPP Client using GTK+/Vala.
* [pdfpc](https://github.com/pdfpc/pdfpc) ⭐ 1,816 | 🐛 28 | 🌐 Vala | 📅 2026-04-23 - A GTK presenter application with multi-monitor support for PDF files.
...
* [Annotator](https://github.com/phase1geo/Annotator) ⭐ 271 | 🐛 5 | 🌐 Vala | 📅 2026-04-29 - Annotate images for better communication.
...
* [Outliner](https://github.com/phase1geo/Outliner) ⭐ 63 | 🐛 6 | 🌐 Vala | 📅 2026-05-04 - Write outlines easily.
...
* [TextShine](https://github.com/phase1geo/TextShine) ⭐ 20 | 🐛 1 | 🌐 Vala | 📅 2026-05-03 - Convert and manipulate text.
...
* [SwayNotifiationCenter](https://github.com/ErikReider/SwayNotificationCenter) ⭐ 2,436 | 🐛 110 | 🌐 Vala | 📅 2026-04-04 - A simple GTK based notification daemon for SwayWM.
* [elementary OS App Center](https://github.com/elementary/appcenter) ⭐ 552 | 🐛 161 | 🌐 Vala | 📅 2026-05-03 - Pay-what-you-can app store for elementary OS.
* [Monitor](https://github.com/stsdc/monitor) ⭐ 357 | 🐛 38 | 🌐 Vala | 📅 2026-04-10 - Manage processes and monitor system resources.
...
* [Valdo](https://github.com/vala-lang/valdo) ⭐ 55 | 🐛 9 | 🌐 Vala | 📅 2026-03-01 - Create new Vala projects from templates.
* [EasyDocs](https://github.com/watsonprojects/EasyDocs) ⭐ 7 | 🐛 4 | 🌐 Vala | 📅 2021-11-26 -  Quickly read developer documentation.
* [Spider](https://github.com/colinkiama/spider) ⭐ 1 | 🐛 0 | 🌐 Vala | 📅 2022-01-08 - Quickly generate a HTML5 site structure.

## Editor Plugins

* [Vala VSCode](https://github.com/vala-lang/vala-vscode) ⭐ 45 | 🐛 10 | 🌐 TypeScript | 📅 2024-07-18 - A plugin for Visual Studio Code that enables basic autocompletion and syntax highlighting for Vala.
...
* [vala-language-server](https://github.com/vala-lang/vala-language-server) ⭐ 331 | 🐛 73 | 🌐 Vala | 📅 2025-09-26 - A language server that aims to provide code completion, formatting, syntax highlighting, and everything else according to the Language Server spec.

## Libraries

### Command-line

* [console-command](https://github.com/naaando/console-command) ⭐ 2 | 🐛 1 | 🌐 Vala | 📅 2018-11-15 - Library to route command-line arguments to a Command pattern object, current implementation covers extension by inheritance or using closures.
...
* [Graphene](https://github.com/ebassi/graphene) ⭐ 427 | 🐛 17 | 🌐 C | 📅 2025-12-19 - A thin layer of types for graphic libraries. It provides common types needed to handle 3D transformations: points, triangles, rectangles, quads, quaternions, vectors, matrices, spheres, etc.
...
* [Almanna ORM](https://github.com/AmbitionFramework/almanna) ⭐ 7 | 🐛 1 | 🌐 Vala | 📅 2022-07-04 -  The Almanna ORM for Vala/GLib.

### Graphics Libraries

* [live-chart](https://github.com/lcallarec/live-chart) ⭐ 79 | 🐛 14 | 🌐 Vala | 📅 2025-01-24 - A real-time charting library for Vala and GTK3 based on Cairo.
* [GRX](https://github.com/ev3dev/grx) ⭐ 21 | 🐛 12 | 🌐 C | 📅 2020-09-24 - A graphics library for simple graphics displays (think 1-bit displays or Adafruit's PiTFT displays). It also includes keyboard, mouse, joystick and touchscreen input support.
...
* [Vadi](https://github.com/nahuelwexd/Vadi) ⚠️ Archived - An IoC Container developed in order to facilitate the usage of dependency injection for Vala developers.
...
* [balistica](https://github.com/fusilero/libbalistica) ⭐ 12 | 🐛 4 | 🌐 Vala | 📅 2020-08-27 - An open source ballistic simulation library. There's a complete calculator [here](https://github.com/fusilero/balistica) ⭐ 65 | 🐛 9 | 🌐 Vala | 📅 2025-09-15.
* [vast](https://github.com/rainwoodman/vast) ⭐ 11 | 🐛 24 | 🌐 Vala | 📅 2017-07-30 - A project for generative modeling in Vala. Think of TensorFlow rewritten in Vala.

### Templating

* [Compose](https://github.com/arteymix/compose) ⭐ 18 | 🐛 1 | 🌐 Vala | 📅 2017-10-27 - A functional templating library for Vala.
...
* [libcmark-vapi](https://github.com/fabrixxm/libcmark-vapi) ⭐ 4 | 🐛 0 | 🌐 Vala | 📅 2018-05-28 - Vala bindings for libcmark, the CommonMark parsing and rendering library in C.
