...
* [Akira](https://github.com/akiraux/Akira) ⭐ 5,322 | 🐛 40 | 🌐 Vala | 📅 2025-12-30 -  Native Linux App for UI and UX Design built in Vala and GTK.
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 532 | 🐛 76 | 🌐 Vala | 📅 2025-11-23 - A font editor for creating fonts in TTF, EOT, SVG and BIRDFONT format.

### Development Tools

* [GitG](https://gitlab.gnome.org/GNOME/gitg) - A graphical user interface for [git](https://git-scm.com/).
* [Kangaroo](https://github.com/dbkangaroo/kangaroo) ⭐ 463 | 🐛 27 | 🌐 TSQL | 📅 2026-02-09 - AI-powered SQL client and admin tool for popular databases.
...
* [Korembi](https://github.com/cheesecakeufo/komorebi) ⭐ 3,696 | 🐛 289 | 🌐 Vala | 📅 2025-07-21 - A beautiful and customizable wallpapers manager for Linux.

### Productivity

* [Planify](https://github.com/alainm23/planify) ⭐ 4,950 | 🐛 169 | 🌐 Vala | 📅 2026-02-10 - Task manager with Todoist support designed for GNU/Linux.
* [Dino](https://github.com/dino/dino) ⭐ 2,383 | 🐛 634 | 🌐 Vala | 📅 2026-02-06 - A modern Jabber/XMPP Client using GTK+/Vala.
...
* [Minder](https://github.com/phase1geo/Minder) ⭐ 1,147 | 🐛 56 | 🌐 Vala | 📅 2026-02-11 - Mind-mapping application.
...
* [Annotator](https://github.com/phase1geo/Annotator) ⭐ 266 | 🐛 13 | 🌐 Vala | 📅 2026-02-01 - Annotate images for better communication.
...
* [SwayNotifiationCenter](https://github.com/ErikReider/SwayNotificationCenter) ⭐ 2,292 | 🐛 87 | 🌐 Vala | 📅 2026-02-10 - A simple GTK based notification daemon for SwayWM.
* [elementary OS App Center](https://github.com/elementary/appcenter) ⭐ 550 | 🐛 168 | 🌐 Vala | 📅 2026-02-10 - Pay-what-you-can app store for elementary OS.
...
* [Valdo](https://github.com/vala-lang/valdo) ⭐ 55 | 🐛 10 | 🌐 Vala | 📅 2023-07-02 - Create new Vala projects from templates.
...
* [vala-language-server](https://github.com/vala-lang/vala-language-server) ⭐ 320 | 🐛 71 | 🌐 Vala | 📅 2025-09-26 - A language server that aims to provide code completion, formatting, syntax highlighting, and everything else according to the Language Server spec.
...
* [balistica](https://github.com/fusilero/libbalistica) ⭐ 12 | 🐛 4 | 🌐 Vala | 📅 2020-08-27 - An open source ballistic simulation library. There's a complete calculator [here](https://github.com/fusilero/balistica) ⭐ 62 | 🐛 9 | 🌐 Vala | 📅 2025-09-15.
